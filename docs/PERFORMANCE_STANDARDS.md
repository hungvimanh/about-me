...
> A **measurable** performance budget for portfolio. Part of [DEFINITION_OF_DONE.md](./DEFINITION_OF_DONE.md), considered at **Phase 2 (set the budget)** + **Phase 4 (verify)** in [AGENCY_WORKFLOW.md](./AGENCY_WORKFLOW.md).
>
